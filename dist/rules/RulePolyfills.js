...
function getFieldValuesForQuery(treeSitterQuery, fieldName, startFromNode) {
    ...
    let query;
    let globalCaptures;
    query = new tree_sitter_1.default.Query(tree_sitter_sfapex_1.default.apex, treeSitterQuery);
    globalCaptures = query.captures(startFromNode);
    globalCaptures.forEach(captureInstance => {
        var _a;
        const newArray = (_a = resultMap.get(captureInstance.name)) !== null && _a !== void 0 ? _a : [];
