...
let ApexBadCrypto = (() => {
  let _classDecorators = [
    (0, sourceloupe_types_1.name)("ApexBadCrypto"),
    (0, sourceloupe_types_1.category)("security"),
    (0, sourceloupe_types_1.context)("scan"),
    (0, sourceloupe_types_1.message)("Apex classes should use random IV/key"),
  ...
  var ApexBadCrypto = (_classThis = class extends _classSuper {
    validateNode(node) {
      ...
      const allEncryptDecryptCalls =
        '(method_invocation object:(identifier) @object (#match? @object "Crypto") name: (identifier) @method (#match? @method "encrypt|decrypt") (argument_list) @args)';
      const goodCryptoGenList = (0, RulePolyfills_1.adHocQuery)(
        allGoodCryptoCalls,
        node,
        true,
      );
      const encryptDecryptCallList = (0, RulePolyfills_1.adHocQuery)(
        allEncryptDecryptCalls,
        node,
        true,
      );
