...
let CyclomaticComplexity = (() => {
    let _classDecorators = [(0, sourceloupe_types_1.name)("CyclomaticComplexity"), (0, sourceloupe_types_1.category)("design"), (0, sourceloupe_types_1.context)("scan"), (0, sourceloupe_types_1.message)("The {0} ''{1}'' has a{2} cyclomatic complexity of {3}."), (0, sourceloupe_types_1.suggestion)(""), (0, sourceloupe_types_1.priority)(3), (0, sourceloupe_types_1.query)("(parser_output)@p"), (0, sourceloupe_types_1.regex)("")];
