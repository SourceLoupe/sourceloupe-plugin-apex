...
// runRule(ruleReuse);
let r = new ApexSharingViolations_1.ApexSharingViolations();
runRule(r);
r = new ApexSOQLInjection_1.ApexSOQLInjection();
runRule(r);
r = new ApexSuggestUsingNamedCred_1.ApexSuggestUsingNamedCred();
runRule(r);
...
// runRule(r);
r = new AvoidDeeplyNestedIfStmts_1.AvoidDeeplyNestedIfStmts();
runRule(r);
r = new AvoidGlobalModifier_1.AvoidGlobalModifier();
runRule(r);
r = new ClassNamingConventions_1.ClassNamingConventions();
runRule(r);
r = new EmptyTryOrFinallyBlock_1.EmptyTryOrFinallyBlock();
runRule(r);
r = new ExcessiveClassLength_1.ExcessiveClassLength();
runRule(r);
r = new ExcessivePublicCount_1.ExcessivePublicCount();
runRule(r);
r = new LocalVariableNamingConventions_1.LocalVariableNamingConventions();
runRule(r);
r = new MethodNamingConventions_1.MethodNamingConventions();
runRule(r);
r = new PropertyNamingConventions_1.PropertyNamingConventions();
runRule(r);
r = new QueueableWithoutFinalizer_1.QueueableWithoutFinalizer();
runRule(r);
r = new TooManyFields_1.TooManyFields();
runRule(r);
